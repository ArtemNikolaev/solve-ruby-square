...
searchButton.addEventListener('click', () => {
  ...
  if (window.Worker) {
    const worker = new Worker('find-solution.js');
    worker.postMessage(['start', initialRubySquare.square, finalRubySquare.square, rotatingSquareSize]);

    worker.onmessage = (e) => {
      drawSolution(e.data, rotatingSquareSize, outputTextSpan, outputSolutionDiv);
